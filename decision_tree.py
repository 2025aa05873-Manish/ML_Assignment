...
# 
# Accuracy (0.8806): This is the proportion of correctly classified instances out of the total instances. An accuracy of 0.8806 means that 88.06% of the model's predictions were correct.
# 
# AUC Score (0.7071): AUC (Area Under the Receiver Operating Characteristic Curve) measures the model's ability to distinguish between positive and negative classes. A score of 0.7071 indicates a reasonable ability to differentiate between the two classes. An AUC of 1 represents a perfect classifier, while 0.5 represents a random classifier.
# 
# Precision (0.4706): For the positive class, precision is the ratio of true positive predictions to the total positive predictions made by the model. A precision of 0.4706 means that when the model predicts a positive outcome, it is correct about 47.06% of the time. It answers: "Of all instances predicted as positive, how many were actually positive?"
# 
# Recall (0.4571): For the positive class, recall (also known as sensitivity) is the ratio of true positive predictions to the total actual positive instances. A recall of 0.4571 means the model correctly identified 45.71% of all actual positive cases. It answers: "Of all actual positive instances, how many were correctly identified?"
# 
