{
 "cells": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "ktuaz4NMN88M",
    "outputId": "55a143ab-bced-4414-aadd-683cd10725b8"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "5affd249",
    "outputId": "389d621b-b877-4981-fcfb-24d6757d3698"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "6206a8c4",
    "outputId": "ef492a61-cf3a-4dae-e57a-81e5072c9ba2"
   },
   "outputs": [
    {
     "data": {
      ...
      "text/html": [
       "\n",
       "  <div id=\"df-d36d4ba3-1bba-45f9-9bda-a9b0ea63cced\" class=\"colab-df-container\">\n",
       "    <div>\n",
       "<style scoped>\n",
       ...
       "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-d36d4ba3-1bba-45f9-9bda-a9b0ea63cced')\"\n",
       ...
       "    <script>\n",
       "      const buttonEl =\n",
       "        document.querySelector('#df-d36d4ba3-1bba-45f9-9bda-a9b0ea63cced button.colab-df-convert');\n",
       "      buttonEl.style.display =\n",
       "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
       "\n",
       "      async function convertToInteractive(key) {\n",
       "        const element = document.querySelector('#df-d36d4ba3-1bba-45f9-9bda-a9b0ea63cced');\n",
       "        const dataTable =\n",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "84a5540c",
    "outputId": "abe8e952-3d74-4abd-9605-4b1a7ac529b3"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "403435c3",
    "outputId": "c2ab162f-a0af-4c70-9d9f-9c76588a2a96"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "060f4d19",
    "outputId": "ce5058d2-e7d6-4635-ab7a-690e2276fbb1"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "acffb941",
    "outputId": "03e73863-ae1b-4d67-ab66-43ebc57f9a89"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "9432d1b8",
    "outputId": "cdb61c59-7bdb-4bcb-be74-0acc8a7f4c0b"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "9375b245",
    "outputId": "74c2b3b4-45e0-456f-aa63-aed41e6885ac"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "22510ea6",
    "outputId": "130453e9-761c-4709-d7a2-f289d9e06425"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "30d54bdf",
    "outputId": "b59f0cf3-912f-4322-ffc8-d75bb3020ec1"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "source": [
    " import the `LogisticRegression` model, instantiate it with specified parameters, and then train it using the preprocessed training data (`X_train` and `y_train`).\n",
    "\n"
   ]
  },
  {
   ...
   "metadata": {
    ...
    "id": "84e8dbc6",
    "outputId": "ab4c521e-2835-4052-d084-ec2531e91af2"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "### Subtask:\n",
    "Make predictions on the test set and calculate the following evaluation metrics: Accuracy, AUC Score, Precision, Recall, F1 Score, and Matthews Correlation Coefficient (MCC Score).\n"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "source": [
    "## Summary:\n",
    "\n",
    "The Logistic Regression model has been successfully built and trained using the preprocessed training data.\n",
    "\n",
    "### Data Analysis Key Findings\n",
    "*   A Logistic Regression model was initialized using `sklearn.linear_model.LogisticRegression`.\n",
    "*   The model was configured with `random_state=42` for reproducibility and `solver='liblinear'`, a good choice for smaller datasets and L1/L2 regularization.\n",
    "*   The model was successfully trained on the preprocessed training data, `X_train` and `y_train`.\n",
    "\n",
    "### Insights or Next Steps\n",
    "*   The trained Logistic Regression model is now ready to be evaluated on the test set using various metrics like Accuracy, AUC Score, Precision, Recall, F1 Score, and MCC Score.\n"
   ]
  },
  {
   "cell_type": "code",
   ...
   "metadata": {
    ...
    "id": "0ba41296",
    "outputId": "fd6f8119-4fd9-419c-e316-8e6f212103a9"
   },
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "Recall: 0.0286\n",
      "F1 Score: 0.0556\n",
      "Matthews Correlation Coefficient (MCC): 0.1595\n"
     ]
    }
   ],
   "source": [
 ...
 "metadata": {
  "colab": {
   "authorship_tag": "ABX9TyP6eiXsRxJ9zC+Nu/kRTqNu",
   "provenance": []
  },
  "kernelspec": {
